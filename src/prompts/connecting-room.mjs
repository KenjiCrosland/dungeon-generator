...
- **Room Type:**
  ...
  - Use the room size and shape to determine the appropriate type:
    - **Long:** Could be a corridor or gallery. If the word "long" is not in the short description, don't say it's that it's a corridor.
...
- **interactive_element_header**: A brief header for the interactive element in the room (e.g., "The Etched Door", "The Faded Map", "The Lever Panel").
...
\`\`\`json
{
  ...
  "interactive_element_header": "The Faded Map",
  "interactive_element_lore": "The map was created by the original architects, showing secret passages and hidden rooms intended for only the most trusted members.",
  "interactive_element_details": "The map is etched into a metal plate mounted on the wall. Players who examine it closely can make an Investigation check to uncover hidden routes. Success reveals a secret door in this hallway or provides advantage on navigating the dungeon.",
  "read_aloud_description": "The corridor stretches before you, its walls adorned with ancient murals depicting forgotten battles. Flickering torchlight casts eerie shadows that dance along the stone floor. Columns carved to resemble intertwined serpents line the hallway. An old, weathered map is mounted on the wall, its details faded but still discernible.",
