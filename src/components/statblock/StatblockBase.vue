<template>
    <div>
        <div :class="`container ${columns}`">
            ...
            <div v-if="!loadingPart2 && monster" class="statblock">
                ...
                <div v-if="monster.legendary_actions && monster.legendary_actions.length > 0">
                    ...
                    <p>The monster can take 3 legendary actions, choosing from the options below. Only one legendary
                        action
        ...
        <div class="copy-statblock-buttons" v-if="copyButtons && !loadingPart1 && !loadingPart2 && monster">
            ...
            <cdr-button modifier="secondary" size="small" @click="copyAsImprovedInitiative">Improved
                Initiative</cdr-button>
        </div>
    </div>
</template>
